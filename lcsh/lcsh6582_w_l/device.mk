...
# PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/ueventd.mt6582.rc:root/ueventd.mt6582.rc

PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/meta_init.project.rc:root/meta_init.project.rc
ifeq ($(strip $(MTK_CIP_SUPPORT)), yes)
  PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/fstab.mt6582.wwop:root/fstab.mt6582
else
  PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/fstab.mt6582:root/fstab.mt6582
endif
# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/lcsh/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/lcsh/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/lcsh/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/lcsh/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/lcsh/$(MTK_TARGET_PROJECT)/MT6582_Android_scatter.txt:MT6582_Android_scatter.txt
...
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/lcsh6582_w_l/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/lcsh6582_w_l/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6582/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
#PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/lcsh6582_w_l/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
#PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/lcsh6582_w_l/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
#PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/lcsh6582_w_l/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png


# USB
PRODUCT_COPY_FILES += device/lcsh/lcsh6582_w_l/init.mt6582.usb.rc:root/init.mt6582.usb.rc

# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/lcsh/lcsh6582_w_l/overlay
...
$(call inherit-product-if-exists, vendor/lcsh/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
